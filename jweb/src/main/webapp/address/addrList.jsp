...
<%
	if(abDAO.getListAll() == null || abDAO.getListAll().size() == 0){
%>
<script>
	var msg = "목록이 없습니다.. 등록창으로 돌아갑니다.";
...
<body>
	<div id="container">
		...
		<table id="tbl_list">
			<tr>
				<td>이름</td><td>전화번호</td><td>이메일</td><td>성별</td><td>보기</td><td>수정</td><td>삭제</td>
			</tr>
			<%
			...
			<tr>
				...
				<td><a href="./addrEdit.jsp?username=<%=addrBook.getUsername() %>">
					<button type="button">수정</button></a></td>
