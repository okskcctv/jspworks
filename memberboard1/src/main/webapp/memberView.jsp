			...
			<form action="./updateProcess.jsp" method="post" name="updateForm">
				...
				%>
					...
					<tr>
						<td>성별</td>
						<td>
							<input type="radio" name="gender" value="남" <% if(member.getGender().equals("남")){ %>checked<% } %>>남
							<input type="radio" name="gender" value="여" <% if(member.getGender().equals("여")){ %>checked<% } %>>여
						</td>
					</tr>
					<tr>
						<td>가입일</td>
